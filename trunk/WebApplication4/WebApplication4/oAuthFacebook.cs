...
namespace WebApplication4
{
    ...
    public class oAuthFacebook
    {
        ...
        public const string CALLBACK_URL = "http://localhost:48284/FBCallback.aspx/";
        ...
        public string ConsumerKey
        {
            get
            {
                ...
                {
                    _consumerKey = "148948948459028"; //Your application ID
                }
                return _consumerKey;
            }
        ...
        public string ConsumerSecret
        {
            get
            {
                ...
                {
                    _consumerSecret = "945214648be6eeedc0b76236109d7089"; //Your application secret
                }
